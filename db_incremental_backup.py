...
def run_db_incremental_backup(site):
	...
	os.system('sudo -u ' + site['linux_user'] + ' ' + 'git --git-dir "' + site_root_db_incremental + '" init')

	### Add the file to the repo if not already
	os.system('sudo -u ' + site['linux_user'] + ' ' + 'git --git-dir "' + site_root_db_incremental + '" add .')

	### Commit the production database to the git repo
	os.system('sudo -u ' + site['linux_user'] + ' ' + 'git --git-dir "' + site_root_db_incremental + '" commit -m "' + get_date_time() + ' db backup" ')
